...
type Event struct {
	...
	SourceEventID     string         `gorm:"column:source_event_id;size:128" json:"source_event_id"`
	IdempotencyKey    string         `gorm:"column:idempotency_key;size:191;uniqueIndex" json:"idempotency_key"`
