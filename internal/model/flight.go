...
// FlightStatusDisabled 是 B3 对航班“未启用”的最小表达。
//
// 当前表结构没有 enabled 字段，因此航班状态机完整化前，只有该状态会阻止
// flight_arrived 事件生成任务；其他状态的业务含义留给后续切片处理。
const FlightStatusDisabled = "disabled"
